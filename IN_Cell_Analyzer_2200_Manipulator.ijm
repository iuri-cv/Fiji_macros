...
// Wrote by: Iuri Cordeiro Valadão (PhD Sciences, University of São Paulo) 
// Last update: 26/03/2021
// @ CONFOCAL Facility (CEFAP-USP)
// ATTENTION: if you use this macro to generate data, please cite it by using the following link: 
